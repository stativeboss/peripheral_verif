...
module mksign_dump(CLK,
  ...
  wire [52 : 0] m_xactor_f_rd_addr_D_IN, m_xactor_f_rd_addr_D_OUT;
  ...
  wire [71 : 0] m_xactor_f_rd_data_D_IN, m_xactor_f_rd_data_D_OUT;
  ...
  wire [52 : 0] m_xactor_f_wr_addr_D_IN, m_xactor_f_wr_addr_D_OUT;
  ...
  wire [6 : 0] m_xactor_f_wr_resp_D_IN;
  ...
  wire [52 : 0] s_xactor_f_rd_addr_D_IN;
  ...
  wire [71 : 0] s_xactor_f_rd_data_D_IN, s_xactor_f_rd_data_D_OUT;
  ...
  wire [52 : 0] s_xactor_f_wr_addr_D_IN, s_xactor_f_wr_addr_D_OUT;
  ...
  wire [6 : 0] s_xactor_f_wr_resp_D_IN, s_xactor_f_wr_resp_D_OUT;
  ...
  reg [1 : 0] CASE_s_xactor_f_wr_addrD_OUT_BITS_24_TO_21_0x_ETC__q2;
  wire [63 : 0] m_xactor_f_rd_dataD_OUT_BITS_69_TO_6_SRL_lv_s_ETC__q3;
  wire [31 : 0] s_xactor_f_wr_dataD_OUT_BITS_44_TO_13_MINUS_r_ETC__q1;
  wire [5 : 0] lv_shift__h2579;
  wire rg_cnt_ULT_5___d2, rg_start_address_0_ULT_rg_end_address_7___d38;

  // value method master_m_awvalid
  assign master_AWVALID = m_xactor_f_wr_addr_EMPTY_N ;

  // value method master_m_awaddr
  assign master_AWADDR = m_xactor_f_wr_addr_D_OUT[52:21] ;

  // value method master_m_awuser
  assign master_AWUSER = m_xactor_f_wr_addr_D_OUT[20] ;
  ...
  // value method master_m_araddr
  assign master_ARADDR = m_xactor_f_rd_addr_D_OUT[52:21] ;

  // value method master_m_aruser
  assign master_ARUSER = m_xactor_f_rd_addr_D_OUT[20] ;
  ...
  // value method slave_m_bresp
  assign slave_BRESP = s_xactor_f_wr_resp_D_OUT[6:5] ;

  // value method slave_m_buser
  assign slave_BUSER = s_xactor_f_wr_resp_D_OUT[4] ;
  ...
  // value method slave_m_rresp
  assign slave_RRESP = s_xactor_f_rd_data_D_OUT[71:70] ;

  // value method slave_m_rdata
  assign slave_RDATA = s_xactor_f_rd_data_D_OUT[69:6] ;

  // value method slave_m_rlast
  assign slave_RLAST = s_xactor_f_rd_data_D_OUT[5] ;

  // value method slave_m_ruser
  assign slave_RUSER = s_xactor_f_rd_data_D_OUT[4] ;
  ...
  FIFO2 #(.width(32'd53), .guarded(1'd1)) m_xactor_f_rd_addr(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd72), .guarded(1'd1)) m_xactor_f_rd_data(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd53), .guarded(1'd1)) m_xactor_f_wr_addr(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd7), .guarded(1'd1)) m_xactor_f_wr_resp(.RST(RST_N),
							    .CLK(CLK),
  ...
  FIFO2 #(.width(32'd53), .guarded(1'd1)) s_xactor_f_rd_addr(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd72), .guarded(1'd1)) s_xactor_f_rd_data(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd53), .guarded(1'd1)) s_xactor_f_wr_addr(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd7), .guarded(1'd1)) s_xactor_f_wr_resp(.RST(RST_N),
							    .CLK(CLK),
  ...
  // submodule m_xactor_f_wr_addr
  assign m_xactor_f_wr_addr_D_IN = 53'h0 ;
  ...
  // submodule m_xactor_f_wr_resp
  assign m_xactor_f_wr_resp_D_IN =
	     { master_BRESP, master_BUSER, master_BID } ;
  ...
  // submodule s_xactor_f_rd_data
  assign s_xactor_f_rd_data_D_IN = 72'h0 ;
  ...
  assign s_xactor_f_wr_resp_D_IN =
	     { CASE_s_xactor_f_wr_addrD_OUT_BITS_24_TO_21_0x_ETC__q2,
	       s_xactor_f_wr_addr_D_OUT[20],
  ...
  // remaining internal signals
  assign lv_shift__h2579 = { ff_lower_order_bits_D_OUT, 3'd0 } ;
  assign m_xactor_f_rd_dataD_OUT_BITS_69_TO_6_SRL_lv_s_ETC__q3 =
	     m_xactor_f_rd_data_D_OUT[69:6] >> lv_shift__h2579 ;
  assign rg_cnt_ULT_5___d2 = rg_cnt < 5'd5 ;
  assign rg_start_address_0_ULT_rg_end_address_7___d38 =
  ...
  begin
    case (s_xactor_f_wr_addr_D_OUT[24:21])
      4'h0, 4'h8:
	  CASE_s_xactor_f_wr_addrD_OUT_BITS_24_TO_21_0x_ETC__q2 = 2'd0;
      default: CASE_s_xactor_f_wr_addrD_OUT_BITS_24_TO_21_0x_ETC__q2 = 2'd2;
    endcase
  end
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  s_xactor_f_wr_addr_D_OUT[24:21] == 4'hC)
	$finish(32'd0);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_receive_response)
	$fwrite(dump,
		"%8h\n",
		m_xactor_f_rd_dataD_OUT_BITS_69_TO_6_SRL_lv_s_ETC__q3[31:0]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_receive_response &&
	  m_xactor_f_rd_data_D_OUT[71:70] != 2'd0)
	begin
	  v__h2859 = $time;
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_receive_response &&
	  m_xactor_f_rd_data_D_OUT[71:70] != 2'd0)
	$display(v__h2859, "\tSIGNATUREDUMP got Bus Error");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_receive_response &&
	  m_xactor_f_rd_data_D_OUT[71:70] != 2'd0)
	$finish(32'd0);
