...
module mkDebugSoc(CLK_tck_clk,
  ...
  mk_debug debug_module(.CLK(CLK),
			...
			.debug_master_BUSER(debug_module_debug_master_BUSER),
			...
			.debug_master_RUSER(debug_module_debug_master_RUSER),
			...
			.debug_slave_ARUSER(debug_module_debug_slave_ARUSER),
			...
			.debug_slave_AWUSER(debug_module_debug_slave_AWUSER),
			...
			.debug_slave_BUSER(debug_module_debug_slave_BUSER),
			...
			.debug_slave_RUSER(debug_module_debug_slave_RUSER),
			...
			.debug_master_AWUSER(debug_module_debug_master_AWUSER),
			...
			.debug_master_ARUSER(debug_module_debug_master_ARUSER),
  ...
  mkSoc soc(.RST_N_hartresets_0(hart_reset_0_OUT_RST),
	    ...
	    .to_debug_master_ARUSER(soc_to_debug_master_ARUSER),
	    ...
	    .to_debug_master_AWUSER(soc_to_debug_master_AWUSER),
	    ...
	    .to_debug_slave_BUSER(soc_to_debug_slave_BUSER),
	    ...
	    .to_debug_slave_RUSER(soc_to_debug_slave_RUSER),
	    ...
	    .to_debug_master_BUSER(soc_to_debug_master_BUSER),
	    ...
	    .to_debug_master_RUSER(soc_to_debug_master_RUSER),
	    ...
	    .to_debug_slave_AWUSER(soc_to_debug_slave_AWUSER),
	    ...
	    .to_debug_slave_ARUSER(soc_to_debug_slave_ARUSER),
  ...
  assign debug_module_debug_master_BUSER = soc_to_debug_master_BUSER ;
  ...
  assign debug_module_debug_master_RUSER = soc_to_debug_master_RUSER ;
  ...
  assign debug_module_debug_slave_ARUSER = soc_to_debug_slave_ARUSER ;
  ...
  assign debug_module_debug_slave_AWUSER = soc_to_debug_slave_AWUSER ;
  ...
  assign soc_to_debug_master_ARUSER = debug_module_debug_master_ARUSER ;
  ...
  assign soc_to_debug_master_AWUSER = debug_module_debug_master_AWUSER ;
  ...
  assign soc_to_debug_slave_BUSER = debug_module_debug_slave_BUSER ;
  ...
  assign soc_to_debug_slave_RUSER = debug_module_debug_slave_RUSER ;
