...
module mkstage5(CLK,
  ...
  wire [63 : 0] _theResult_____1__h9032, x__h11696, x__h6288, x__h9225;
  wire [11 : 0] csr_address__h6048,
  ...
  // value method csrs_mv_resume_wfi
  assign csrs_mv_resume_wfi = x__h11696 != 64'd0 ;
  ...
  assign x__h11696 = csr_sbread_mv_csr_mip & csr_sbread_mv_csr_mie ;
  assign x__h6288 =
	     (rx_rx_systemout_from_stage4_first_x[2:0] == 3'd0) ?
	       csr_sbread_mv_csr_mstatus :
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  rg_epoch_1_EQ_IF_rx_fuid_w_data_whas__1_THEN_r_ETC___d54)
	$display("Dynamic assertion failed: \"src//stage5.bsv\", line 280, column 32\nReceived unexpected Micro-Trap cause");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_writeback_trap &&
	  rg_epoch_1_EQ_IF_rx_fuid_w_data_whas__1_THEN_r_ETC___d54)
	$finish(32'd0);
